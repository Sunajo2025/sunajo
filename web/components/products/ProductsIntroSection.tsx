...
export default function ProductsIntroSection() {
  ...
  const handleScrollToNext = () => {
    const productsSection = document.getElementById('products-details');
    if (productsSection) {
      ...
      <div className="w-full px-4 max-w-7xl flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16 relative z-10">
        ...
        <div className="flex flex-col text-left w-full md:w-auto md:flex-1 animate-slideUp">
          ...
          <div className="mb-4 sm:mb-6 ">
            ...
            >
              Innovation. Quality. Performance. Trust.
            </span>
          </div>
          ...
          >
            Our products are designed to simplify complex processes, enhance user experiences, and drive business outcomes. 
            From smart web platforms and data-driven tools to scalable enterprise solutions, 
            we build with innovation at the core — ensuring seamless performance, security, and impact.
          </p>
