...
export default function CapabilitiesIntroSection() {


    const handleScrollTonNext = () => {
    const contactSection = document.getElementById('capabilities-details');
    if (contactSection) {
      ...
      <div className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16 relative z-10">
        ...
        <div className="flex flex-col text-left w-full md:w-auto md:flex-1 animate-slideUp">
          ...
          <div className="mb-4 sm:mb-6">
            ...
            >
              Innovation. Experience. Expertise. Growth.
            </span>
          </div>
          ...
          >
            Our capabilities span across strategy, design, and technology — helping brands unlock their true potential. 
            From crafting intuitive user experiences and building scalable digital ecosystems to driving data-driven insights, 
            we deliver end-to-end innovation that fuels lasting impact.
          </p>
