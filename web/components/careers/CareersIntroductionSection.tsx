...
export default function CareersIntroductionSection() {
  const handleScrollTonNext = () => {
    const nextSection = document.getElementById('CareersContentSection');
    if (nextSection) {
    ...
    <section className="relative py-20 md:py-28 px-4 sm:px-6 lg:px-8 flex justify-center overflow-hidden bg-black">
      ...
      <div className="w-full px-2 max-w-7xl flex flex-col md:flex-row items-center justify-between gap-8 md:gap-16 relative z-10">
        ...
        <div className="flex flex-col text-left w-full md:w-auto md:flex-1 animate-slideUp">
          ...
          >
            At <span className="text-white font-medium">BASE</span>, we believe in empowering individuals to create, innovate, and lead. 
            Join a culture where your ideas matter, your growth is prioritized, 
            and your work makes a real-world impact across industries.
          </p>
        </div>
